...
//                break;
    ...
    public boolean execute(final String action, JSONArray args, final CallbackContext callbackContext) throws JSONException {
        ...
        if (ACTION_INIT.equals(action)) {
            ...
            FlicManager.init(this.cordova.getActivity().getApplicationContext(), PluginSettings.getAppId(), PluginSettings.getAppSecret());
            Log.d(TAG, "FlicManager Ready");
            Flic.this.manager = FlicManager.getManager();
...
//    }
    ...
    private JSONObject createJSONButton(FlicButton button) {
        ...
        try {
            if (button != null) {
                String buttonId = button.getButtonUuid();
                String color = "";
                String status = BUTTON_STATUS.values()[button.getConnectionState()].name();
